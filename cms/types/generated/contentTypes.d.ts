...
export interface ApiEducationalSessionEducationalSession
  extends Struct.CollectionTypeSchema {
  collectionName: 'educational_sessions';
  info: {
    displayName: 'Educational-session';
    pluralName: 'educational-sessions';
    singularName: 'educational-session';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::educational-session.educational-session'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::educational-session.educational-session': ApiEducationalSessionEducationalSession;
